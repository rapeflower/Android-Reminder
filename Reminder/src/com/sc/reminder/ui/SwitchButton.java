...
public class SwitchButton extends CompoundButton {
    ...
    private int tempSlideX = -5; //X轴当前坐标，用于动态绘制图片显示坐标，实现滑动效果
        ...
        this.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				...
				if (null != onCheckedChange) {
					onCheckedChange.onChange(buttonView, isChecked);
				}
			}
		});
    }
    ...
    private class SwitchScroller implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.isFinished()) {
				if (!checked) {
					setDrawableResIds(R.drawable.switch_frame1, R.drawable.selector_switch_state, R.drawable.switch_state_mask, R.drawable.selector_switch_slider);
				}
				else {
					setDrawableResIds(R.drawable.switch_frame, R.drawable.selector_switch_state, R.drawable.switch_state_mask, R.drawable.selector_switch_slider);
				}
            }
        }
    }
    ...
    public interface OnCheckedChange {
    	void onChange(CompoundButton buttonView, boolean isChecked);
    }

	public OnCheckedChange getOnCheckedChange() {
